...
export default function ActionButton({
  ...
  const baseBtn =
    'relative flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-base shadow-lg transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:ring-offset-2 select-none disabled:opacity-60 disabled:cursor-not-allowed';
  const secondary =

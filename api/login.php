...
require_once __DIR__ . '/../backend/lib/rate_limit.php';
require_once __DIR__ . '/../backend/lib/log.php';
require_once __DIR__ . '/../backend/lib/jwt.php';
...
try {
    $pdo = getPDO();
    $stmt = $pdo->prepare('SELECT id, nom, prenom, email, password_hash, email_confirmed, role FROM users WHERE LOWER(email) = LOWER(?) LIMIT 1');
